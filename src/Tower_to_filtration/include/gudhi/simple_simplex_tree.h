...
public:
	...
	void remove_simplex(simplex_vertex_range &simplex, std::vector<index> *removedIndices = nullptr);
	void remove_simplex(simplex_handle &simplex, std::vector<index> *removedIndices = nullptr);
...
inline void Simplex_tree::remove_simplex(simplex_vertex_range &simplex, std::vector<index> *removedIndices)
{
	Node *simplexNode = find(simplex);
	remove_simplex(simplexNode, removedIndices);
}

inline void Simplex_tree::remove_simplex(simplex_handle &simplex, std::vector<index> *removedIndices)
{
