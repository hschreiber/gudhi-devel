...
using Edge_graph = Gudhi::strong_collapse::Edge_graph<Simplex_tree>;
...
int main(int argc, char* argv[]) {
	...
	Gudhi::Proximity_graph<Simplex_tree> prox_graph =
			Gudhi::compute_proximity_graph<Simplex_tree>(off_reader.get_point_cloud(), threshold, Gudhi::Euclidean_distance());
